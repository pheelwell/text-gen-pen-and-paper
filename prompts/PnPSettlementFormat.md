...
PromptInfo:
  author: pheelwell
  description: null
  id: PnPSettlementFormat
  name: "\U0001F9D9 Rewrite as 🏰Settlement template🏰"
  version: 0.0.1
---
...
## Overview
two paragraphs with most important facts about the Faction 
## Notable Locations:
- [[Location 1]]: Description...
- [[Location 2]]: Description
## Notable Figures:
- [[Figure 1]]: Context to Settlement
- etc
